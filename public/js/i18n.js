const I18n = {
    ...
    translations: {
        en: {
            nav_map: 'Map', nav_nearby: 'Nearby', nav_profile: 'Profile', nav_add: 'Add',
            ...
            challenge_gamble_title: 'Double or Nothing',
            challenge_gamble_desc: 'Stake all your stars and rating. In 15 days, 50% of participants will double their stake, the rest will lose everything.',
            challenge_neuroprofiler_title: '30 <a href="https://t.me/ThreadsNeuroBot" target="_blank" style="color: var(--accent-light); text-decoration: underline;">NeuroProfiler</a> Checks',
            challenge_neuroprofiler_desc: 'Exchange all your stars and rating for 30 checks in bot. Will be issued on April 1st.',
            challenge_vpn_title: '30 Days VPN Access',
            challenge_vpn_desc: 'Exchange stars and rating for 30 days of VPN access. Will be issued on April 1st.',
            challenge_burn_title: 'Burn Stars & Rating',
            challenge_burn_desc: 'Reset all your rating and stars permanently. They cannot be recovered.',
            challenge_burn_participants: 'Already burned: {count} players.',
            challenge_minimum_10: 'You need at least 10 stars and 10 rating to participate.',
            challenge_invalid_challenge_type: 'Invalid challenge type',
            challenge_join_btn: 'Participate',
            challenge_joined: 'You are participating!',
            challenge_confirm: 'All your stars ({stars}) and rating ({rating}) will be staked. Continue?',
            challenge_nothing_to_stake: 'You have no stars or rating to stake',
            challenge_already_participating: 'You are already participating in this challenge',
            challenge_disabled: 'This challenge is currently unavailable',
            challenge_joined_toast: 'You joined the challenge!',
            challenge_timer_left: '{time} left',
            challenge_status_won: '🎉 Won! x2 returned',
            challenge_status_lost: '💀 All lost',
            challenge_status_completed: '🎁 Gift issued',
            challenge_status_burn_completed: '🔥 That was brave!',
            challenge_status_expired: '⏰ Expired',
            challenge_staked: 'Staked: {stars}⭐ + {rating} rating'
        },
        ru: {
            nav_map: 'Карта', nav_nearby: 'Рядом', nav_profile: 'Профиль', nav_add: 'Добавить',
            ...
            // Challenges
            challenges_title: 'Испытания',
            challenge_gamble_title: 'Удвоить или потерять',
            challenge_gamble_desc: 'Поставь все свои звезды и рейтинг. Через 15 дней 50% участников удвоят ставку, остальные потеряют всё.',
            challenge_neuroprofiler_title: '30 проверок в <a href="https://t.me/ThreadsNeuroBot" target="_blank" style="color: var(--accent-light); text-decoration: underline;">Нейро-Профайлере</a>',
            challenge_neuroprofiler_desc: 'Обменяй все звёзды и рейтинг на 30 проверок в боте НейроПрофайлер. Будет выдано 1 апреля.',
            challenge_vpn_title: 'VPN доступ на 30 дней',
            challenge_vpn_desc: 'Обменяй звёзды и рейтинг на доступ к VPN на 30 дней. Будет выдано 1 апреля.',
            challenge_burn_title: 'Сжечь звёзды и рейтинг',
            challenge_burn_desc: 'Обнули весь свой рейтинг и все звёзды навсегда. Их больше не вернуть.',
            challenge_burn_participants: 'Уже сожгли: {count} чел.',
            challenge_minimum_10: 'Для участия нужно минимум 10 звёзд и 10 рейтинга',
            challenge_invalid_challenge_type: 'Неверный тип испытания',
            challenge_join_btn: 'Участвовать',
            challenge_joined: 'Вы участвуете!',
            challenge_confirm: 'Все ваши звёзды ({stars}) и рейтинг ({rating}) будут поставлены. Продолжить?',
            challenge_nothing_to_stake: 'У вас нет звёзд или рейтинга для ставки',
            challenge_already_participating: 'Вы уже участвуете в этом испытании',
            challenge_disabled: 'Это испытание сейчас недоступно',
            challenge_joined_toast: 'Вы присоединились к испытанию!',
            challenge_timer_left: 'Осталось: {time}',
            challenge_status_won: '🎉 Победа! x2 возвращено',
            challenge_status_lost: '💀 Всё потеряно',
            challenge_status_completed: '🎁 Подарок выдан',
            challenge_status_burn_completed: '🔥 Это было смело!',
            challenge_status_expired: '⏰ Истекло',
            challenge_staked: 'Ставка: {stars}⭐ + {rating} рейтинг'
        }
    },
